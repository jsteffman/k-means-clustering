...
cluster_solutions %>% 
  ...
  ylab("scaled ERB")+ylab("prop. word duration")+
  geom_line(alpha=0.3)
...
cluster_solutions %>% 
  ...
  scale_color_colorblind()+
   ylim(-2.25,2.8)+
  ylab("scaled ERB")+xlab("prop. word duration")+
...
- Here, 30 time-scaled samples, speaker means for each of the 8 stimulus tunes (8 trajectories per speaker, 240 total)
...
- *Temporal TCoG*: Roughly, when in scaled time is F0 the highest? Earlier for falls, later for rises
